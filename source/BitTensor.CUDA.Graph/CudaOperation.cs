...
public abstract class CudaOperation<T> : CudaNode<T>, IDifferentiable<T> where T : unmanaged, IFloatingPoint<T>
{
    ...
    protected CudaOperation(Shape shape, CudaNode<T>[] children) : base(shape)
    {
