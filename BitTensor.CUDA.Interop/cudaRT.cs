...
public static unsafe partial class cudaRT
{
    ...
    public static extern cudaError cudaStreamCopyAttributes(CUstream_st* dst, CUstream_st* src);

    [DllImport(__DllName, EntryPoint = "cudaStreamGetAttribute", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamGetAttribute(CUstream_st* hStream, cudaLaunchAttributeID attr, cudaLaunchAttributeValue* value_out);

    [DllImport(__DllName, EntryPoint = "cudaStreamSetAttribute", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamSetAttribute(CUstream_st* hStream, cudaLaunchAttributeID attr, cudaLaunchAttributeValue* value);

    [DllImport(__DllName, EntryPoint = "cudaStreamDestroy", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamDestroy(CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaStreamWaitEvent", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamWaitEvent(CUstream_st* stream, CUevent_st* @event, uint flags);

    [DllImport(__DllName, EntryPoint = "cudaStreamAddCallback", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamAddCallback(CUstream_st* stream, delegate* unmanaged[Cdecl]<CUstream_st*, cudaError, void*, void> callback, void* userData, uint flags);

    [DllImport(__DllName, EntryPoint = "cudaStreamSynchronize", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamSynchronize(CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaStreamQuery", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamQuery(CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaStreamAttachMemAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamAttachMemAsync(CUstream_st* stream, void* devPtr, nuint length, uint flags);

    [DllImport(__DllName, EntryPoint = "cudaStreamBeginCapture", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamBeginCapture(CUstream_st* stream, cudaStreamCaptureMode mode);
    ...
    public static extern cudaError cudaStreamBeginCaptureToGraph(CUstream_st* stream, CUgraph_st* graph, CUgraphNode_st** dependencies, cudaGraphEdgeData_st* dependencyData, nuint numDependencies, cudaStreamCaptureMode mode);
    ...
    public static extern cudaError cudaStreamEndCapture(CUstream_st* stream, CUgraph_st** pGraph);

    [DllImport(__DllName, EntryPoint = "cudaStreamIsCapturing", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamIsCapturing(CUstream_st* stream, cudaStreamCaptureStatus* pCaptureStatus);

    [DllImport(__DllName, EntryPoint = "cudaStreamGetCaptureInfo_v2", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamGetCaptureInfo_v2(CUstream_st* stream, cudaStreamCaptureStatus* captureStatus_out, ulong* id_out, CUgraph_st** graph_out, CUgraphNode_st*** dependencies_out, nuint* numDependencies_out);

    [DllImport(__DllName, EntryPoint = "cudaStreamGetCaptureInfo_v3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaStreamGetCaptureInfo_v3(CUstream_st* stream, cudaStreamCaptureStatus* captureStatus_out, ulong* id_out, CUgraph_st** graph_out, CUgraphNode_st*** dependencies_out, cudaGraphEdgeData_st** edgeData_out, nuint* numDependencies_out);
    ...
    public static extern cudaError cudaStreamUpdateCaptureDependencies(CUstream_st* stream, CUgraphNode_st** dependencies, nuint numDependencies, uint flags);
    ...
    public static extern cudaError cudaStreamUpdateCaptureDependencies_v2(CUstream_st* stream, CUgraphNode_st** dependencies, cudaGraphEdgeData_st* dependencyData, nuint numDependencies, uint flags);
    ...
    public static extern cudaError cudaEventRecord(CUevent_st* @event, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaEventRecordWithFlags", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaEventRecordWithFlags(CUevent_st* @event, CUstream_st* stream, uint flags);
    ...
    public static extern cudaError cudaSignalExternalSemaphoresAsync_v2(CUexternalSemaphore_st** extSemArray, cudaExternalSemaphoreSignalParams* paramsArray, uint numExtSems, CUstream_st* stream);
    ...
    public static extern cudaError cudaWaitExternalSemaphoresAsync_v2(CUexternalSemaphore_st** extSemArray, cudaExternalSemaphoreWaitParams* paramsArray, uint numExtSems, CUstream_st* stream);
    ...
    public static extern cudaError cudaLaunchKernel(void* func, dim3 gridDim, dim3 blockDim, void** args, nuint sharedMem, CUstream_st* stream);
    ...
    public static extern cudaError cudaLaunchCooperativeKernel(void* func, dim3 gridDim, dim3 blockDim, void** args, nuint sharedMem, CUstream_st* stream);
    ...
    public static extern cudaError cudaMemcpy3DAsync(cudaMemcpy3DParms* p, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpy3DPeerAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpy3DPeerAsync(cudaMemcpy3DPeerParms* p, CUstream_st* stream);
    ...
    public static extern cudaError cudaMemcpyAsync(void* dst, void* src, nuint count, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpyPeerAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpyPeerAsync(void* dst, int dstDevice, void* src, int srcDevice, nuint count, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpy2DAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpy2DAsync(void* dst, nuint dpitch, void* src, nuint spitch, nuint width, nuint height, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpy2DToArrayAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpy2DToArrayAsync(cudaArray* dst, nuint wOffset, nuint hOffset, void* src, nuint spitch, nuint width, nuint height, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpy2DFromArrayAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpy2DFromArrayAsync(void* dst, nuint dpitch, cudaArray* src, nuint wOffset, nuint hOffset, nuint width, nuint height, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpyToSymbolAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpyToSymbolAsync(void* symbol, void* src, nuint count, nuint offset, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpyFromSymbolAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpyFromSymbolAsync(void* dst, void* symbol, nuint count, nuint offset, cudaMemcpyKind kind, CUstream_st* stream);
    ...
    public static extern cudaError cudaMemsetAsync(void* devPtr, int value, nuint count, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemset2DAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemset2DAsync(void* devPtr, nuint pitch, int value, nuint width, nuint height, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemset3DAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemset3DAsync(cudaPitchedPtr pitchedDevPtr, int value, cudaExtent extent, CUstream_st* stream);
    ...
    public static extern cudaError cudaMemPrefetchAsync(void* devPtr, nuint count, int dstDevice, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemPrefetchAsync_v2", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemPrefetchAsync_v2(void* devPtr, nuint count, cudaMemLocation location, uint flags, CUstream_st* stream);
    ...
    public static extern cudaError cudaMemcpyToArrayAsync(cudaArray* dst, nuint wOffset, nuint hOffset, void* src, nuint count, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMemcpyFromArrayAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMemcpyFromArrayAsync(void* dst, cudaArray* src, nuint wOffset, nuint hOffset, nuint count, cudaMemcpyKind kind, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaMallocAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaMallocAsync(void** devPtr, nuint size, CUstream_st* hStream);

    [DllImport(__DllName, EntryPoint = "cudaFreeAsync", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaFreeAsync(void* devPtr, CUstream_st* hStream);
    ...
    public static extern cudaError cudaMallocFromPoolAsync(void** ptr, nuint size, CUmemPoolHandle_st* memPool, CUstream_st* stream);
    ...
    public static extern cudaError cudaGraphicsMapResources(int count, cudaGraphicsResource** resources, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaGraphicsUnmapResources", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaGraphicsUnmapResources(int count, cudaGraphicsResource** resources, CUstream_st* stream);
    ...
    public static extern cudaError cudaGraphUpload(CUgraphExec_st* graphExec, CUstream_st* stream);

    [DllImport(__DllName, EntryPoint = "cudaGraphLaunch", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern cudaError cudaGraphLaunch(CUgraphExec_st* graphExec, CUstream_st* stream);
...
{
    public ulong flags;
    public CUstream_st* uploadStream;
