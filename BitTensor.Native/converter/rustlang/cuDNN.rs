...
fn bindgen_test_layout_cudnnAlgorithmUnionStruct_Algorithm() {
    const UNINIT: ::std::mem::MaybeUninit<cudnnAlgorithmUnionStruct_Algorithm> =
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).convFwdAlgo) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cudnnAlgorithmUnionStruct_Algorithm),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).convBwdFilterAlgo) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cudnnAlgorithmUnionStruct_Algorithm),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).convBwdDataAlgo) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cudnnAlgorithmUnionStruct_Algorithm),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).RNNAlgo) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cudnnAlgorithmUnionStruct_Algorithm),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).CTCLossAlgo) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cudnnAlgorithmUnionStruct_Algorithm),
...
fn bindgen_test_layout_cudnnAlgorithmUnionStruct() {
    const UNINIT: ::std::mem::MaybeUninit<cudnnAlgorithmUnionStruct> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_cudnnConvolutionFwdAlgoPerfStruct() {
    const UNINIT: ::std::mem::MaybeUninit<cudnnConvolutionFwdAlgoPerfStruct> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_cudnnConvolutionBwdDataAlgoPerfStruct() {
    const UNINIT: ::std::mem::MaybeUninit<cudnnConvolutionBwdDataAlgoPerfStruct> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_cudnnConvolutionBwdFilterAlgoPerfStruct() {
    const UNINIT: ::std::mem::MaybeUninit<cudnnConvolutionBwdFilterAlgoPerfStruct> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
